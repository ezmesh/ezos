...
local ENTRIES = {
    ...
    { key = "map_peer_inf",    type = "string", default = "1",
      options = { "0", "1" },
      description = "Map: show repeaters and room servers as pins" },
    { key = "map_peer_con",    type = "string", default = "1",
      options = { "0", "1" },
      description = "Map: show my contacts as pins" },
    { key = "map_peer_all",    type = "string", default = "0",
      options = { "0", "1" },
      description = "Map: show every heard chat node (privacy-aware off by default)" },
    { key = "map_peer_stale",  type = "string", default = "0",
      options = { "0", "1" },
      description = "Map: include peers last heard 1-7 days ago (rendered dim)" },
